...
public class UtilFile2Sql {
     ...
     */
    public static <T> T getFieldNew(T t, List<String> nameList, List<String> dataList) throws IllegalArgumentException, IllegalAccessException, NoSuchFieldException, InstantiationException, ClassNotFoundException {
        //获得类
